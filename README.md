...
You need a C++ development toolchain, including `cmake` at least 3.12 and [Boost](https://www.boost.org/) at least 1.54. You also need Git. With the dependencies installed, you run the following commands:
